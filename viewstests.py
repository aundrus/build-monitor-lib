...
# Import Django and custom utilities for test results view
...
def testviewDemo(request):
    ...
    Handles request validation, query parameters, DB queries, and result formatting.
    Returns either JSON or HTML response based on request type.
    Args:
        request: Django request object
    Returns:
        JsonResponse or rendered HTML page
    """
    valid, response = initRequest(request)
    if not valid:
        return response
    # Extract parameters from session or use defaults
    ...
    # Icon HTML snippets for status indicators
    ...
    clock_icon = '<div class="ui-widget ui-state-active" style="display:inline-block;background:#bc0000;"> <span style="display:inline-block;" title="UPDATING" class="DataTables_sort_icon css_right ui-icon ui-icon-clock">ICON39</span></div>'
    ...
    blank_icon = '<div class="ui-widget ui-state-disabled" style="display:inline-block";> <span title="N/A" class="ui-icon ui-icon-blank">ICONBL</span></div>'
    note_icon = '<div class="ui-widget ui-state-disabled" style="display:inline-block";> <span title="N/A" class="ui-icon ui-icon-note">ICONNT</span></div>'
    cancel_icon = '<div class="ui-widget ui-state-check" style="display:inline-block";> <span title="N/A" class="ui-icon ui-icon-cancel">ICON20</span></div>'
