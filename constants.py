...
# Date/time format for displaying timestamps
DATETIME_FORMAT = "%Y/%m/%d %H:%M"
# Number of days to show ART results
N_DAYS_ART_RESULTS = 10
# Cache timeout for ART results (in seconds)
CACHE_TIMEOUT_SECONDS_ART_RESULTS = 30*60 # 30 minutes

# HTML icon snippets for UI status indicators
